...
- Browser ready at `http://localhost:3000` (Next.js falls back to `3001` if the port is busy).
...
> beaming across the void it re-encodes the payload into the *next* hop's dialect — Dawn's base 6.
